...
public class LevelsDescription : MonoBehaviour
{
    ...
    public static int[][] level1 = new int[][] {
        new int[] { 0, 1, sdT }, new int[] { 9, 5, dT - sdT },
        new int[] { 1, 2, dT },
        new int[] { 2, 3, dT },
        new int[] { 1, 2, dT },
        new int[] { 0, 1, dT },
        ...
        new int[] { 1, 2, dT },
        new int[] { 0, 2, dT },
        new int[] { 6, 3, sdT }, new int[] { 10, 6, dT - sdT },
        new int[] { 7, 2, sdT }, new int[] { 12, 5, dT - sdT },
        new int[] { 8, 1, sdT }, new int[] { 13, 4, dT - sdT },

        new int[] { 14, 1, sdT }, new int[] { 25, 5, dT - sdT },
        new int[] { 4, 2, sdT }, new int[] { 26, 6, dT - sdT },
        new int[] { 15, 1, dT },
        new int[] { 4, 2, sdT }, new int[] { 27, 6, dT - sdT },
        new int[] { 14, 1, sdT }, new int[] { 28, 5, dT - sdT },
        new int[] { 4, 2, sdT }, new int[] { 26, 6, dT - sdT },
        new int[] { 16, 1, sdT }, new int[] { 12, 5, dT - sdT },
        new int[] { 15, 1, sdT }, new int[] { 13, 5, dT - sdT },
        new int[] { 18, 1, dT },
        ...
        new int[] { 1, 1, dT },
        new int[] { 2, 2, dT },
        new int[] { 1, 1, sdT }, new int[] { 9, 5, dT - sdT },
        ...
        new int[] { 22, 3, sdT }, new int[] { 31, 7, dT - sdT },
        new int[] { 22, 3, sdT }, new int[] { 31, 7, dT - sdT },
        new int[] { 22, 3, sdT }, new int[] { 31, 7, dT - sdT },
        ...
        new int[] { 0, 1, sdT }, new int[] { 32, 5, dT - sdT },
